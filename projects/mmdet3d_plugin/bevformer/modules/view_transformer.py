...
# from projects.mmdet3d_plugin.ops import bev_pool
...
#     x = QuickCumsum.apply(feats, coords, ranks)
#     x = x.permute(0, 4, 1, 2, 3).contiguous()
#     return x

# @NECKS.register_module()
class ViewTransformerLiftSplatShoot_solo(BaseModule):
    def __init__(self, grid_config=None, data_config=None,
                 ...
                 **kwargs):
        super(ViewTransformerLiftSplatShoot_solo, self).__init__()
...
@NECKS.register_module()
class ViewTransformerLSSBEVDepth(ViewTransformerLiftSplatShoot_solo):
