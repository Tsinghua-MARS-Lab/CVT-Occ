...
# for cost volume
use_refine_feat_loss = True
use_temporal = 'costvolume'
use_temporal_self_attention = False
use_padding = False
# important parameter
refine_feat_loss_weight = 500
...
sampled_queue_length = 7 # only for costvolume
sample_num = [30, 25, 20, 15, 10, 5, 0] # only for test
